  ...
  return (
    <div className="flex-row">
      ...
      {/* <div class="btn-group-vertical justify-content-start bg-secondary" role="group" aria-label="Basic example" style={{ padding: '2px' }}>
        ...
        <button onClick={handleDrawer} data-tip data-for="fileSystem" type="button" className="btn btn-secondary mb-1" style={{ maxHeight: '40px', width: '40px', borderRadius: '5px' }}><i class="fas fa-copy"></i></button>
