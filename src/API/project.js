...
const postProject = async (token, data) => {
    try {
        const result = await instance.post('/projects', {
            name: data.name,
...
const addMember = async (token, projectId, data) => {
    try {
        const result = await instance.patch('/projects/add/' + projectId, {
...
const removeMember = async (token, projectId, data) => {
    try {
        const result = await instance.patch('/projects/remove/' + projectId, {
            memberId: data.memberId
        }, {
            headers: {
                Authorization: 'Bearer ' + token
